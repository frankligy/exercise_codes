...
if __name__ == '__main__':
    ...
    # for color
    plt.colormaps()  # all color maps, just specify the string
    from matplotlib.colors import ListedColormap
    palette = ListedColormap(['g','r'])  # a ListedColorMap object
    ...
    # ticks
    axes1.xaxis.set_major_locator()  # a locator object, mpl.ticker
    axes1.set_xticks()
